...
BLOG_TITLE = "Try Out Nikola"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ravi-chandran.github.io/try-nikola/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ravi-chandran.github.io/try-nikola/"
...
POSTS = (
    ("posts/*.md", "posts", "post.tmpl"),  # make .md default - changed by RC
    ("posts/*.rst", "posts", "post.tmpl"),
    ("posts/*.txt", "posts", "post.tmpl"),
    ("posts/*.html", "posts", "post.tmpl"),
)
PAGES = (
    ("pages/*.md", "pages", "page.tmpl"),  # make .md default - changed by RC
...
LOGO_URL = 'rcnotebook.png'

# If you want to hide the title of your website (for example, if your logo
# already contains the text), set this to False.
SHOW_BLOG_TITLE = False  # changed by RC
...
GITHUB_SOURCE_BRANCH = 'master'    # changed by RC
GITHUB_DEPLOY_BRANCH = 'gh-pages'  # changed by RC
...
# before deploying.
GITHUB_COMMIT_SOURCE = False  # changed by RC
